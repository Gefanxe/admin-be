        ...
        properties: {
          ...
          data: {
            ...
            properties: {
              roles: {
                type: "array",
                items: { type: "string", description: "權限組別" }
              },
              username: { type: "string", description: "帳號" },
              name: { type: "string", description: "名字" },
              avatar: { type: "string", description: "頭像" },
              email: { type: "string", description: "email" },
              introduction: { type: "string", description: "介紹" },
              last_login_ip: { type: "string", description: "最後登入IP" }
            },
          },
...
const userCreate = {
  schema: {
    ...
    body: {
      ...
      required: [],
      properties: {
        username: { type: "object", description: "帳號", properties: {
          value: { 
            type: 'string',
            pattern: "^[A-Za-z]{1}[A-Za-z0-9]{5,20}" 
          }}},
        password: { type: "object", description: "密碼", properties: {
          value: { 
            type: 'string', 
            // pattern: "" 
          }}},
        name: { type: "object", description: "名字", properties: {
          value: { 
            type: 'string', 
            // pattern: "" 
          }}},
        email: { type: "object", description: "email", properties: {
          value: { 
            type: 'string', 
            // pattern: "" 
          }}},
        introduction: { type: "object", description: "介紹", properties: {
          value: { 
            type: 'string', 
            pattern: "^.{1,100}$"
          }}},
        avatar: { isFileType: true, description: "頭像" }
      },
    },
    response: {
      "2xx": {
